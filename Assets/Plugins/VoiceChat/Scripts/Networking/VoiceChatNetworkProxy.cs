...
namespace VoiceChat.Networking
{
    public class VoiceChatNetworkProxy : NetworkBehaviour
    {
        ...
        void OnNewSample(VoiceChatPacket packet)
        {
			...
			UnityEngine.Networking.NetworkManager.singleton.client.SendUnreliable(VoiceChatMsgType.Packet, packetMessage);
        }
        ...
        {
			var client = UnityEngine.Networking.NetworkManager.singleton.client;
